...
```
docker build -t terraform:0.8.6 base/ --build-arg TERRAFORM_VERSION=0.8.6 --build-arg DIRENV_VERSION=2.10.0 --build-arg PECO_VERSION=0.4.9 --build-arg GHQ_VERSION=0.7.4
```
